...
//  PerfectDude
//
//  Created by Yannis De Cleene on 07/11/2018.
...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        applicationCoordinator = AppCoordinator(rootViewController: rootViewController,
                                                ...
                                                useCaseProvider: UseCaseProvider().mockUseCaseProvider)
    ...
    lazy var persistentContainer: NSPersistentContainer = {
        ...
        */
        let container = NSPersistentContainer(name: "PerfectDude")
